...
public class CameraFollow : MonoBehaviour
{
    ...
    public void FollowTarget(Transform t)
    {
        ...
        transform.localPosition = Vector3.SmoothDamp(localPos, new Vector3(targetLocalPos.x + offset.x, targetLocalPos.y + offset.y, localPos.z), ref velocity, smoothTime); //Sigue el player de manera mas suave
    }

    //Lineas que dibujan los limites marcados en la funcion Late Update
